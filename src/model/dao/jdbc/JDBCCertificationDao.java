...
import model.dao.interfaces.CertificationDao;
...
public class JDBCCertificationDao implements CertificationDao {
    ...
    public ObservableList<Certification> select(int user_id) {
        ...
        try{
            ...
            PreparedStatement preparedStatement = connection.prepareStatement("SELECT * FROM TEST.CERTIFICATIONS WHERE USER_ID = ?");
