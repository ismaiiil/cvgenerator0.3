...
import com.aequasys.model.dao.interfaces.ReportDao;
...
public class JDBCReportDao implements ReportDao {
    ...
    public ObservableList<Report> select(int user_id) {
        ...
        try{
            ...
            PreparedStatement preparedStatement = connection.prepareStatement("SELECT * FROM TEST.REPORTS WHERE USER_ID = ? ORDER BY YEAR DESC");
    ...
    public ObservableList<Report> selectByLastYears(int id, int yearDifference) {
        ...
        try{
            ...
            PreparedStatement preparedStatement = connection.prepareStatement("SELECT * FROM TEST.REPORTS WHERE USER_ID=? " +
                    "AND REPORTS.YEAR >= EXTRACT(YEAR FROM current_date)-? ORDER BY YEAR DESC");
            preparedStatement.setInt(1,id);
            preparedStatement.setInt(2,yearDifference);
            ResultSet resultSet = preparedStatement.executeQuery();
            Report report = null;
